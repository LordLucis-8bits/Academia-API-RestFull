...
import com.academia.student.dto.UpdateStudentDTO;
...
public class StudentService {
    ...
    public StudentResponseDTO getStudentById(@NonNull String id) {
    ...
    public void renewPlan(@NonNull String id, @NonNull PlanType newPlanType) {
     StudentModel student = studentRepository.findById(id)
     .orElseThrow(() -> new IllegalArgumentException("Student not found"));
    ...
    public LocalDate calculateEndDate(@NonNull PlanType planType, @NonNull LocalDate newStartDate) {
        switch (planType) {
            case DAILY:
