...
import com.academia.instructor.dto.UpdateInstructorDTO;
...
public class InstructorService {
    ...
    //Admin obtem informação do instrutor
    ...
    public InstructorResponseDTO getCurrentInstructorInfo() {
        ...
        InstructorModel instructor = instructorRepository.findByUserId(user.getId())
        .orElseThrow(() -> new IllegalArgumentException("Instructor not found"));
