...
public class GymClassController {
    ...
    @PreAuthorize("hasRole('ADMIN',)")
    public ResponseEntity<GymClassResponseDTO> updateClass(@PathVariable @NonNull String id, UpdateGymClassDTO dto) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Void> deleteClass(@PathVariable @NonNull String id) {
